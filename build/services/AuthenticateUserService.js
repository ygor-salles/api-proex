...
var AuthenticateUserService = /** @class */ (function () {
    ...
    AuthenticateUserService.prototype.execute = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            var connectUser, user, isMatchPassword, token;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        connectUser = typeorm_1.getCustomRepository(UserRepository_1.UserRepository);
                        return [4 /*yield*/, connectUser.findOne({ email: email })];
                    case 1:
                        user = _b.sent();
                        if (!user) {
                            return [2 /*return*/, { status: http_status_1.default.BAD_REQUEST, message: 'Credenciais incorretas!' }];
                        }
